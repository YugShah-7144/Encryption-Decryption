 ...
 * @author DELL
 */
public class DecryptText extends javax.swing.JFrame {

    /**
     * Creates new form DecryptText
     */
    public DecryptText() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecryptText.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DecryptText().setVisible(true);
            }
        });
    }
